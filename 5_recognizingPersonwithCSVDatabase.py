...
MAX_RUN_TIME_SECONDS = 10            # Stop after 10 seconds 
...
while (time.time() - start_time) < MAX_RUN_TIME_SECONDS and not attendance_marked:
    ...
    if rects and is_positioned_well:
        ...
        if proba >= TARGET_CONFIDENCE:
            ...
            # Do not break here, let the break happen outside the loop for cleanup
        
        # --- Visual Feedback for Low Confidence ---
        # If face is found but not yet confirmed, show the low confidence status
